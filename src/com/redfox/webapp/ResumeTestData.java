...
public class ResumeTestData {
    ...
    public static Resume constructResume(String uuid, String fullName) {
        ...
        resumeSections.put(SectionType.ACHIEVEMENT, new ListSection(Arrays.asList(
        ...
        resumeSections.put(SectionType.QUALIFICATIONS, new ListSection(Arrays.asList(
        ...
        resumeSections.put(SectionType.EXPERIENCE, new OrganizationSection(Arrays.asList(
                ...
                new Organization("RIT Center", null,
                        LocalDate.ofYearDay(Integer.valueOf("2012"), Integer.valueOf("04")), LocalDate.ofYearDay(Integer.valueOf("2014"), Integer.valueOf("10")),
                        "Java архитектор",
                ...
                new Organization("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/",
                        LocalDate.ofYearDay(Integer.valueOf("2010"), Integer.valueOf("12")), LocalDate.ofYearDay(Integer.valueOf("2012"), Integer.valueOf("04")),
                        "Ведущий программист",
                        "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части CRM. Реализация RIA-приложения для администрирования, мониторинга и анализа результатов в области алгоритмического трейдинга. JPA, Spring, Spring-MVC, GWT, ExtGWT (GXT), Highstock, Commet, HTML5.",
                        null),
                new Organization("Yota", "https://www.yota.ru/",
                        LocalDate.ofYearDay(Integer.valueOf("2008"), Integer.valueOf("06")), LocalDate.ofYearDay(Integer.valueOf("2010"), Integer.valueOf("12")),
                        "Ведущий специалист",
                ...
                new Organization("Enkata", "http://enkata.com/",
                        LocalDate.ofYearDay(Integer.valueOf("2007"), Integer.valueOf("03")), LocalDate.ofYearDay(Integer.valueOf("2008"), Integer.valueOf("06")),
                        "Разработчик ПО",
                        "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining).",
                        null),
                new Organization("Siemens AG", "https://www.siemens.com/ru/ru/home.html",
                        LocalDate.ofYearDay(Integer.valueOf("2005"), Integer.valueOf("01")), LocalDate.ofYearDay(Integer.valueOf("2007"), Integer.valueOf("02")),
                        "Разработчик ПО",
                        "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix).",
                        null),
                new Organization("Alcatel", "http://www.alcatel.ru/",
                        LocalDate.ofYearDay(Integer.valueOf("1997"), Integer.valueOf("09")), LocalDate.ofYearDay(Integer.valueOf("2005"), Integer.valueOf("01")),
        ...
        resumeSections.put(SectionType.EDUCATION, new OrganizationSection(Arrays.asList(
                new Organization("Coursera", "https://www.coursera.org/course/progfun",
                        LocalDate.ofYearDay(Integer.valueOf("2013"), Integer.valueOf("03")), LocalDate.ofYearDay(Integer.valueOf("2013"), Integer.valueOf("05")),
                        "\"Functional Programming Principles in Scala\" by Martin Odersky",
                        null,
                        null
                ),
                new Organization("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366",
                        LocalDate.ofYearDay(Integer.valueOf("2011"), Integer.valueOf("03")), LocalDate.ofYearDay(Integer.valueOf("2011"), Integer.valueOf("04")),
                        "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"",
                        null,
                        null
                ),
                new Organization("Siemens AG", "http://www.siemens.ru/",
                        LocalDate.ofYearDay(Integer.valueOf("2005"), Integer.valueOf("01")), LocalDate.ofYearDay(Integer.valueOf("2005"), Integer.valueOf("04")),
                        "3 месяца обучения мобильным IN сетям (Берлин)",
                        null,
                        null
                ),
                new Organization("Alcatel", "http://www.alcatel.ru/",
                        LocalDate.ofYearDay(Integer.valueOf("1997"), Integer.valueOf("09")), LocalDate.ofYearDay(Integer.valueOf("1998"), Integer.valueOf("03")),
                        "Закончил с отличием",
                        null,
                        null
                ),
                new Organization("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", "http://www.ifmo.ru/",
                        ...
                        Arrays.asList(
                                new Period(
                                        LocalDate.ofYearDay(Integer.valueOf("1993"), Integer.valueOf("09")), LocalDate.ofYearDay(Integer.valueOf("1996"), Integer.valueOf("07")),
                ...
                new Organization("Заочная физико-техническая школа при МФТИ", "http://www.school.mipt.ru/",
                        LocalDate.ofYearDay(Integer.valueOf("1984"), Integer.valueOf("09")), LocalDate.ofYearDay(Integer.valueOf("1987"), Integer.valueOf("06")),
                        "Закончил с отличием",
                        null,
                        null
                )
